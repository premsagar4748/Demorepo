...
export class Stores {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes['storesFilterData'] && changes['storesFilterData'].currentValue) {
      ...
      this.storeIds=[]
     changes['storesFilterData'].currentValue.storeids.toString().includes(',') >0 ?   
     this.storeIds =  changes['storesFilterData'].currentValue.storeids : 
     this.storeIds.push(parseInt(changes['storesFilterData'].currentValue.storeids)) 
      this.storeIds ?  this.storeIds = this.storeIds?.map((x: any) => parseInt(x, 10)) : ''
      ...
      if (this.storesFilterData.storesArray && this.storesFilterData.storesArray.length > 0) {
        this.getGroupBaseStores(this.groupId.toString(), 'C')
      }
  ...
  individualgroups(e: any) {
    ...
    this.getGroupBaseStores(this.groupId.toString(), 'I')
  }
  getGroupBaseStores(id: any, type: any) {
