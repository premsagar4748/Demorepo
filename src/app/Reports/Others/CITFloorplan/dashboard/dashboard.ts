...
export class Dashboard implements OnInit {
  ...
  constructor(
    ...
    if (localStorage.getItem('flag') == 'V') {
      ...
      let allordebit = localStorage.getItem('flag2')
      console.log(localStorage.getItem('flag2'), allordebit, '...................................................................')
  ...
  //   this.spinnerLoader = false;
  //   this.selectedstoreIdsues = this.stores.map((a: any) => a.ID);
