...
export class Dashboard {
  ...
  constructor(
 public shared: Sharedservice, public setdates: Setdates
  ) {
    ...
    if(localStorage.getItem('UserDetails') != null){
      ...
      this.StoreVal= this.shared.common.redirectionFrom.flag=='M' ?  JSON.parse(
        localStorage.getItem('UserDetails')!
      ).Store_Ids : this.shared.common.redirectionFrom.store ;
      
      // if (this.shared.common.redirectionFrom.flag == 'V') {
      //   this.setDates(this.shared.common.redirectionFrom.Type)
      //   this.dateType = this.shared.common.redirectionFrom.Type
      // }
      // else {
      //   this.setDates('MTD')
      //   this.dateType = 'MTD'
  ...
  logSaving(url: any, object: any, time: any, status: any) {
    ...
    if (
      ...
      const obj = {
        ...
        UL_PageName: 'FandI manager Ranking',
